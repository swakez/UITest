...
///////////////////////////////
    ...
    var status_label = {"Active":"success","Listed":"warning" }
    for (var i = 0; i < project_list.length; i++){
      var badge_class = status_label[project_list[i].status]
      var myHtmlContent = "<tr class=\"mdc-data-table__row\"><td class=\"mdc-data-table__cell\">"+project_list[i].name+
                              "</td><td class=\"mdc-data-table__cell\"><div class=\"badge badge-"+badge_class+"\">"
                              +project_list[i].status+"</td><td class=\"mdc-data-table__cell font-weight-medium\"> "+project_list[i].location+" </td></tr><tr>"
      var tableRef = document.getElementById('recent_projects').getElementsByTagName('tbody')[0];
